...
Providing `ReadBuf` and `WriteBuf` traits for working with byte buffers. `bufkit` focuses on predictable memory usage and comprehensive error handling.
